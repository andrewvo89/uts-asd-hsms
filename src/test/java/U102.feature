...
Feature: U102
   ...
   Scenario Outline: Start editing a user
      ...
      And U102 I change phone to <phone> and email to <email>
      Then U102 I should get a message indicating <result>
      Examples:
         |phone               |email                    |result     |
#          |"+614885646"        |"aaron1@hsms.edu.au"     |"success"  |
#          |"203abc"            |"aaron@gmail.com"        |"danger"   |
#          |"046458764"         |"principal@hsms.edu.au"  |"success"  |
#          |"+61+485646"        |"aaronchen@outlook.com"  |"danger"   |
